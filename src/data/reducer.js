import {USER_STORAGE_KEY, WindowMode} from "./state";

export const ActionType = {
    SetUser: "SET_USER",
    SetViewGroup: "SET_VIEW_GROUP",
    SetViewItem: "SET_VIEW_ITEM",
    SetDate: "SET_DATE",
...
const MainDataReducer = (state, action) => {
    ...
    switch (type) {
        ...
        case ActionType.SetViewGroup:
            return {...state, viewGroup: value}
        case ActionType.SetViewItem:
            return {...state, viewItem: value}
