...
| relocation-web/public/cesium  | 移設シミュレーション機能　Cesiumライブラリ                                                                                                                                                                                                                                                                                                                              |
| relocation-websrc/src/cesium  | 移設シミュレーション機能　Cesiumライブラリ（開発用）                                                                                                                                                                                                                                                                                                             |
| relocation-websrc/src/data   | 移設シミュレーション機能 データマネージャ                                                                                                                                                                                                                                                                                                                |
| relocation-websrc/src/manager   | 移設シミュレーション機能　アプリ標準スタイル                                                                                                                        |
| relocation-websrc/src/map_layers   | 移設シミュレーション機能　マップレイヤーファイル                                                                                  |
| relocation-websrc/src/resources/images   | 移設シミュレーション機能　画像アセット                                                                                       |
| relocation-websrc/src/view   | 移設シミュレーション機能　 UIコンポーネント群                                                                                        |
